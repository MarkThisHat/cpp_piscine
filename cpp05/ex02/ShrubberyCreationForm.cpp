...
ShrubberyCreationForm::ShrubberyCreationForm()
  :AForm("Default", SHRUBBERY_SIGN_GRADE, SHRUBBERRY_EXEC_GRADE) {}

ShrubberyCreationForm::ShrubberyCreationForm(const std::string target)
  :AForm(target, SHRUBBERY_SIGN_GRADE, SHRUBBERRY_EXEC_GRADE) {}
...
std::string ShrubberyCreationForm::getSpec() const {
  return "Shrubbery Creation Form with target <" + getName() + ">";
}
